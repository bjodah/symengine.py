...
cdef class GroebnerBasis:
    ...
    def is_zero_dimensional(self):
        """Whether the ideal has finitely many solutions (over the algebraic
        closure). This is the same condition :meth:`fglm` requires."""
...
def is_zero_dimensional(G, gens, **kwargs):
    """Whether the ideal generated by ``G`` (expected to be a Groebner basis
    under the given order) is zero-dimensional, i.e. has finitely many
